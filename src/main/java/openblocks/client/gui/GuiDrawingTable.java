...
public class GuiDrawingTable extends BaseGuiContainer<ContainerDrawingTable> {
    ...
    public GuiDrawingTable(ContainerDrawingTable container) {
        ...
        GuiComponentIconButton buttonLeft = new GuiComponentIconButton(
                47,
                32,
                0xFFFFFF,
                FakeIcon.createSheetIcon(0, 82, 16, 16),
                BaseComponent.TEXTURE_SHEET);
        ...
        GuiComponentIconButton buttonRight = new GuiComponentIconButton(
                108,
                32,
                0xFFFFFF,
                FakeIcon.createSheetIcon(16, 82, -16, 16),
                BaseComponent.TEXTURE_SHEET);
