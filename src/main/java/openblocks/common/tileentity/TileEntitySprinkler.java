...
public class TileEntitySprinkler extends SyncedTileEntity
        implements ISurfaceAttachment, IInventoryProvider, IHasGui, INeighbourAwareTile {
    ...
    private final GenericInventory inventory = registerInventoryCallback(
            new TileEntityInventory(this, "sprinkler", true, 9) {
    ...
    private void attemptFertilize() {
        ...
        final int fertilizerChance = hasBonemeal ? Config.sprinklerBonemealFertizizeChance
    ...
    private void sprayParticles() {
        if (tank.getFluidAmount() > 0) {
            ...
            while (outletPosition <= 0.5) {
                ...
                Vec3 vec = Vec3
                        .createVectorHelper(forwardVelocityX + sideVelocityX, 0.35, forwardVelocityZ + sideVelocityZ);
