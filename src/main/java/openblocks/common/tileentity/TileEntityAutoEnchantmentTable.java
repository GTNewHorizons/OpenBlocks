...
public class TileEntityAutoEnchantmentTable extends SyncedTileEntity implements IInventoryProvider, IHasGui,
        IConfigurableGuiSlots<AutoSlots>, ILevelChanger, IInventoryCallback, INeighbourAwareTile {
    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote) {
            ...
            if (hasStack(Slots.input) && inventory.isItemValidForSlot(Slots.input.ordinal(), getStack(Slots.input))
    ...
    private void handleBookRotation() {
        ...
        EntityPlayer entityplayer = this.worldObj
                .getClosestPlayer(this.xCoord + 0.5F, this.yCoord + 0.5F, this.zCoord + 0.5F, 3.0D);
