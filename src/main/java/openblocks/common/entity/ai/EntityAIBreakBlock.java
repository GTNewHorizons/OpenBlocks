...
public class EntityAIBreakBlock extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (hasTicked && entity.worldObj != null && !entity.worldObj.isRemote) {
            for (int i = 0; i < 20; i++) {
                ...
                blockCoord = new Coord((int) (x + entity.posX), (int) (y + entity.posY), (int) (z + entity.posZ));
    ...
    public boolean continueExecuting() {
        return entity.isEntityAlive() && !pathFinder.noPath() && blockCoord != null && canHarvestBlock(blockCoord);
    }
                ...
                FakePlayerPool.instance.executeOnPlayer((WorldServer) world, new PlayerUser() {
                    ...
                    public void usePlayer(OpenModsFakePlayer fakePlayer) {
                        ...
                        if (ForgeHooks.canHarvestBlock(block, fakePlayer, meta)) {
                            block.harvestBlock(world, fakePlayer, blockCoord.x, blockCoord.y, blockCoord.z, meta);
