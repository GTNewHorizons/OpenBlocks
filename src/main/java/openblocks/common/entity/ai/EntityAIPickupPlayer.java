...
public class EntityAIPickupPlayer extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (!minime.worldObj.isRemote) {
            List<EntityPlayer> players = WorldUtils
                    .getEntitiesWithinAABB(minime.worldObj, EntityPlayer.class, minime.boundingBox.expand(10, 10, 10));
    ...
    public boolean continueExecuting() {
        return minime.isEntityAlive() && !pathFinder.noPath() && canRidePlayer(targetPlayer);
    }
